...
/* Place includes here */
#define MSG_PRIVATE     "TYPING"       /* PRIV */
#define TOK_PRIVATE     "Tl"     /* 33 */
#define MSG_NOTICE      "NOTICE"        /* NOTI */
#define TOK_NOTICE      "B"     /* 66 */

ModuleHeader MOD_HEADER(m_message)
  = {
	"typing",	/* Name of module */
	"1.0", /* Version */
	"allows typing notifications", /* Short description of module */
	"3.2-b8-1",
	NULL 
    };
...
DLLFUNC int MOD_INIT(m_message)(ModuleInfo *modinfo)
{
	...
	CommandAdd(modinfo->handle, "TYPING", "Tp", m_typing, 3, M_USER);
	return MOD_SUCCESS;
...
DLLFUNC int  m_typing(aClient *cptr, aClient *sptr, int parc, char *parv[])
{
